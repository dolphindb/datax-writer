...
* **table**
	...
	* type 枚举值以及对应DataX数据类型如下。DolphinDB的数据类型及精度，请参考 [数据类型](https://www.dolphindb.cn/cn/help/DataTypesandStructures/DataTypes/index.html)
	...
	---|---|---
     ...
     NANOTIMESTAMP|DT_NANOTIMESTAMP| DATE
     INT|DT_INT|LONG
     LONG|DT_LONG|LONG
     UUID|DT_UUID|STRING
     SHORT|DT_SHORT|LONG
